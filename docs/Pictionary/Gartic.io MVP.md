...
1. **Servidor de comunicação em tempo real**:
    ...
    - [ ] Configurar um servidor com **Socket.IO** (Node.js ou outra tecnologia para WebSocket).
    - [ ] Gerenciar eventos de conexão, desconexão e mensagens.
2. **Gerenciamento de salas**:
    
    - [ ] Criar, listar e excluir salas.
...
3. **Sincronização do jogo**:
    ...
    - [ ] Enviar atualizações em tempo real para os participantes (desenho, chat, etc.).
...
5. **Gerenciamento de usuários**:
    ...
    - [ ] Opção para jogar como visitante.
...
1. **Tela inicial**:
    ...
    - [ ] Botão para criar ou entrar em salas.
2. **Sistema de salas**:
...
3. **Tela de jogo**:
    ...
    - [ ] **Canvas de desenho**:
        - Ferramentas de desenho (pincel, borracha, cores básicas).
    - [ ] **Chat em tempo real**:
        - Enviar e exibir mensagens.
...
1. **Web Application**:
    ...
    - [ ] Desenvolver o frontend em **Flutter Web**, React ou outra tecnologia.
...
- [ ] **Frontend**: Flutter Web (você já domina) ou React.js.
